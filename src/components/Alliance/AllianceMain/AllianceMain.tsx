...
const AllianceMain = () => {
  return (
    <section className={styles.AllianceMainWrapper}>
      ...
      <div className={styles.AllianceMainSubTitle}>예약 일정 관리와 고객 정보를 편하게 관리 할 수 있어요.</div>
      <div className={styles.AllianceMainBookingContent}>
        <div className={styles.AllianceMainBooking}>
          <StaticImage src="../../../images/alliance/alliance_main_content_1.png" alt="allianceMainContent1" />
          <div>몽글 앱을 통한 노출 + 예약</div>
        </div>
        <div className={styles.AllianceMainBooking}>
          <div>고객, 반려동물 정보 확인 가능</div>
          <StaticImage src="../../../images/alliance/alliance_main_content_2.png" alt="allianceMainContent2" />
        </div>
      </div>
      <div className={styles.AllianceMainScheduleContent}>
        <div className={styles.AllianceMainSchedule}>
          <StaticImage src="../../../images/alliance/alliance_main_content_3.png" alt="allianceMainContent3" />
          <StaticImage src="../../../images/alliance/alliance_main_content_4.png" alt="allianceMainContent4" />
        </div>
      ...
      <div className={styles.AllianceMainManageContent}>
        ...
        <StaticImage src="../../../images/alliance/alliance_main_content_5.png" alt="allianceMainContent5" />
      </div>
    </section>
  );
};
